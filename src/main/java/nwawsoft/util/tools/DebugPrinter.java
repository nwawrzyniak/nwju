package nwawsoft.util.tools;

/**
 * Used to only create command line output in programs if the {@code DEBUG} boolean in this file is set.
 */
public class DebugPrinter {
    private static final boolean DEBUG = true;

    /**
     * Prints which method called this one and prints the passed String if the {@code DEBUG} flag is set.
     *
    ...
    /**
     * Prints the passed String if the {@code DEBUG} flag is set.
     *
     * @param printableString the String to print.
     */
    ...
    /**
     * Prints the passed String no matter if the {@code DEBUG} flag is set or not.
